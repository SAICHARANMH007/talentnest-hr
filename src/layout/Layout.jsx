...
// ── Nav definitions ────────────────────────────────────────────────────────────
const NAVS = {
  candidate:  [{id:"dashboard",icon:"🏠",label:"Dashboard"},{id:"explore-jobs",icon:"🌍",label:"Explore Jobs"},{id:"job-match",icon:"🎯",label:"Job Match"},{id:"smart-match",icon:"✨",label:"Smart Match"},{id:"applications",icon:"📋",label:"My Applications"},{id:"offer-comparison",icon:"⚖️",label:"Offer Comparison"},{id:"job-alerts",icon:"🔔",label:"Job Alerts"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"background-verification",icon:"🛡️",label:"BGV Documents"},{id:"resume-builder",icon:"📄",label:"Resume Builder"},{id:"profile",icon:"👤",label:"My Profile"}],
  recruiter:  [{id:"dashboard",icon:"📊",label:"Dashboard"},{id:"applicants",icon:"📇",label:"Applicants"},{id:"jobs",icon:"💼",label:"My Jobs"},{id:"candidates",icon:"🧑‍💼",label:"My Candidates"},{id:"assigned-candidates",icon:"🎯",label:"Assigned to Me"},{id:"talent-match",icon:"🎯",label:"Talent Match"},{id:"smart-match",icon:"✨",label:"Smart Match"},{id:"pipeline",icon:"🔄",label:"Pipeline"},{id:"talent-pool",icon:"🅿️",label:"Talent Pool"},{id:"interviews",icon:"📅",label:"Interviews"},{id:"offers",icon:"📄",label:"Offers"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"assessments",icon:"📝",label:"Assessments"},{id:"outreach",icon:"📣",label:"Outreach"},{id:"candidate-requests",icon:"📨",label:"Candidate Requests"},{id:"profile",icon:"👤",label:"My Profile"}],
