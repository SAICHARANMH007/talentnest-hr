...
// ── Nav definitions ────────────────────────────────────────────────────────────
const NAVS = {
  candidate:  [{id:"dashboard",icon:"🏠",label:"Dashboard"},{id:"smart-match",icon:"✨",label:"Find Jobs"},{id:"opportunities",icon:"🎯",label:"Opportunities"},{id:"applications",icon:"📋",label:"My Applications"},{id:"interviews",icon:"📅",label:"My Interviews"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"⭐",label:"Company Reviews"},{id:"offer-comparison",icon:"⚖️",label:"Offer Comparison"},{id:"job-alerts",icon:"🔔",label:"Job Alerts"},{id:"refer-earn",icon:"🪙",label:"Refer & Grow"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"background-verification",icon:"🛡️",label:"BGV Documents"},{id:"profile",icon:"👤",label:"My Profile"}],
  recruiter:  [{id:"dashboard",icon:"📊",label:"Dashboard"},{id:"my-performance",icon:"🏆",label:"My Performance"},{id:"applicants",icon:"📇",label:"Applicants"},{id:"jobs",icon:"💼",label:"My Jobs"},{id:"college-drives",icon:"🎓",label:"College Drives"},{id:"candidates",icon:"🧑‍💼",label:"My Candidates"},{id:"assigned-candidates",icon:"🎯",label:"Assigned to Me"},{id:"talent-match",icon:"🔍",label:"Job Match"},{id:"pipeline",icon:"🔄",label:"Pipeline"},{id:"talent-pool",icon:"🅿️",label:"Talent Pool"},{id:"interviews",icon:"📅",label:"Interviews"},{id:"offers",icon:"📄",label:"Offers"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"assessments",icon:"📝",label:"Assessments"},{id:"outreach",icon:"📣",label:"Outreach"},{id:"candidate-requests",icon:"📨",label:"Candidate Requests"},{id:"job-requirements",icon:"📋",label:"Client Requirements"},{id:"clients",icon:"🏢",label:"Clients"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"⭐",label:"Company Reviews"},{id:"profile",icon:"👤",label:"My Profile"}],
  admin:      [{id:"analytics",icon:"📈",label:"Overview"},{id:"insights",icon:"🔍",label:"Insights"},{id:"applicants",icon:"📇",label:"Applicants"},{id:"job-approvals",icon:"✅",label:"Job Approvals"},{id:"candidates",icon:"👤",label:"Candidates"},{id:"college-drives",icon:"🎓",label:"College Drives"},{id:"drive-approvals",icon:"🏫",label:"Drive Approvals"},{id:"outreach",icon:"📣",label:"Outreach"},{id:"assessments",icon:"📝",label:"Assessments"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"candidate-requests",icon:"📨",label:"Candidate Requests"},{id:"assigned-candidates",icon:"🎯",label:"Assignments"},{id:"recruiters",icon:"🧑‍💼",label:"Recruiters"},{id:"hiring-managers",icon:"🧑‍💻",label:"Hiring Managers"},{id:"org-chart",icon:"🏢",label:"Org Chart"},{id:"job-requirements",icon:"📋",label:"Client Requirements"},{id:"jobs",icon:"💼",label:"All Jobs"},{id:"interview-kits",icon:"📋",label:"Interview Kits"},{id:"webhooks",icon:"🔗",label:"Webhooks"},{id:"diversity",icon:"⚖️",label:"Diversity"},{id:"reviews",icon:"⭐",label:"Reviews"},{id:"referrals",icon:"👥",label:"Referrals"},{id:"talent-pool",icon:"🏊",label:"Talent Pool"},{id:"nps-dashboard",icon:"🌟",label:"NPS"},{id:"time-to-fill",icon:"⏱️",label:"Time to Fill"},{id:"duplicate-merge",icon:"🔀",label:"Merge Duplicates"},{id:"face-duplicates",icon:"🔐",label:"Face Duplicates"},{id:"sourcing-tracker",icon:"📡",label:"Sourcing Tracker"},{id:"rejection-templates",icon:"📝",label:"Rejection Templates"},{id:"offer-letter-builder",icon:"📜",label:"Offer Letter Builder"},{id:"dashboard-widgets",icon:"🧩",label:"Dashboard Widgets"},{id:"headcount-planner",icon:"👥",label:"Headcount Planner"},{id:"sla-alerts",icon:"🚨",label:"Hiring Alerts"},{id:"custom-stages",icon:"🔄",label:"Custom Stages"},{id:"skill-assessments",icon:"🎯",label:"Skill Assessments"},{id:"automation",icon:"⚡",label:"Automation"},{id:"customizations",icon:"🎛️",label:"Customizations"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"reported-posts",icon:"🚩",label:"Reported Posts"},{id:"audit-logs",icon:"🗒️",label:"Audit Logs"},{id:"org-settings",icon:"⚙️",label:"Org Settings"},{id:"modal-guide",icon:"🗂️",label:"Platform Guide"},{id:"billing",icon:"💳",label:"Billing"},{id:"profile",icon:"👤",label:"My Profile"}],
  superadmin: [{id:"command-center",icon:"🚀",label:"Command Center"},{id:"analytics",icon:"📈",label:"Overview"},{id:"platform",icon:"🌐",label:"Platform"},{id:"organisations",icon:"🏢",label:"Organisations"},{id:"reviews",icon:"⭐",label:"Company Reviews"},{id:"nps-dashboard",icon:"🌟",label:"NPS Dashboard"},{id:"reported-posts",icon:"🚩",label:"Reported Posts"},{id:"candidates",icon:"👤",label:"Registered Users"},{id:"unregistered-candidates",icon:"🕵️",label:"Guest Applicants"},{id:"all-candidates",icon:"🗂️",label:"Candidate Database"},{id:"college-groups",icon:"🏫",label:"College Groups"},{id:"company-groups",icon:"🏢",label:"Company Groups"},{id:"applicants",icon:"📄",label:"Application Records"},{id:"job-approvals",icon:"✅",label:"Job Approvals"},{id:"drive-approvals",icon:"🏫",label:"Drive Approvals"},{id:"billing",icon:"💳",label:"Billing"},{id:"security",icon:"🛡️",label:"Security"},{id:"audit-logs",icon:"🗒️",label:"Audit Logs"},{id:"face-duplicates",icon:"🔐",label:"Face Duplicates"},{id:"permissions",icon:"🔐",label:"Permissions"},{id:"import-candidates",icon:"📥",label:"Import & Assign"},{id:"recruiters",icon:"🧑‍💼",label:"Recruiters"},{id:"hiring-managers",icon:"🧑‍💻",label:"Hiring Managers"},{id:"admins",icon:"🔑",label:"Admins"},{id:"jobs",icon:"💼",label:"All Jobs"},{id:"assessments",icon:"📝",label:"Assessments"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"bgv-tracker",icon:"🛡️",label:"BGV Tracker"},{id:"automation",icon:"⚡",label:"Automation"},{id:"customizations",icon:"⚙️",label:"Customizations"},{id:"outreach",icon:"📣",label:"Outreach"},{id:"contact-leads",icon:"📞",label:"Contact Enquiries"},{id:"candidate-requests",icon:"📨",label:"Candidate Requests"},{id:"playbooks",icon:"📚",label:"Playbooks"},{id:"blogs",icon:"✍️",label:"Blog Manager"},{id:"referrals",icon:"👥",label:"Job Referrals"},{id:"platform-referrals",icon:"🪙",label:"Platform Referrals"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"🏢",label:"Org Reviews Page"},{id:"modal-guide",icon:"🗂️",label:"Modal Guide"},{id:"profile",icon:"👤",label:"My Profile"}],
  client:     [{id:"dashboard",icon:"🏢",label:"Dashboard"},{id:"requirements",icon:"📋",label:"Hiring Requirements"},{id:"shortlists",icon:"🌟",label:"Shortlists"},{id:"interviews",icon:"📅",label:"Interviews"},{id:"placements",icon:"🏆",label:"Placements"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"⭐",label:"Company Reviews"},{id:"profile",icon:"👤",label:"My Profile"}],
  college:    [{id:"analytics",icon:"📈",label:"Overview"},{id:"candidates",icon:"🎓",label:"Students"},{id:"add-candidates",icon:"📥",label:"Add Candidates"},{id:"applicants",icon:"📇",label:"Placement Records"},{id:"drives",icon:"📣",label:"Placement Drives"},{id:"skill-gaps",icon:"📊",label:"Skill Gap Analytics"},{id:"training-resources",icon:"📚",label:"Training Resources"},{id:"reviews",icon:"⭐",label:"Reviews"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"org-settings",icon:"⚙️",label:"Org Settings"},{id:"profile",icon:"👤",label:"My Profile"}],
  hiring_manager: [{id:"dashboard",icon:"📊",label:"Dashboard"},{id:"my-team",icon:"🧑‍💼",label:"My Team"},{id:"pipeline",icon:"🔄",label:"Pipeline"},{id:"interviews",icon:"📅",label:"Interviews"},{id:"job-requirements",icon:"📋",label:"Client Requirements"},{id:"clients",icon:"🏢",label:"Clients"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"⭐",label:"Company Reviews"},{id:"profile",icon:"👤",label:"My Profile"}],
};
        ...
        <>
          ...
          <div style={{ padding: isMobile ? '10px 16px' : '8px 16px', borderTop: '1px solid #F3F2F2', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0, background: '#FAFAFA', gap: 8 }}>
            ...
            <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
              {userRole === 'candidate' && (
                <button onClick={() => { setOpen(false); navigate('/app/settings/notifications'); }}
