...
// ── Nav definitions ────────────────────────────────────────────────────────────
const NAVS = {
  candidate:  [{id:"dashboard",icon:"🏠",label:"Dashboard"},{id:"explore-jobs",icon:"🔍",label:"Explore Jobs"},{id:"ai-match",icon:"🤖",label:"AI Job Search"},{id:"applications",icon:"📋",label:"My Applications"},{id:"job-alerts",icon:"🔔",label:"Job Alerts"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"profile",icon:"👤",label:"My Profile"},{id:"resume-builder",icon:"📄",label:"Resume Builder"}],
