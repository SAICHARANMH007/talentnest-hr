...
const NAVS = {
  ...
  client:     [{id:"dashboard",icon:"🏢",label:"Dashboard"},{id:"shortlists",icon:"🌟",label:"Shortlists"},{id:"interviews",icon:"📅",label:"Interviews"},{id:"placements",icon:"🏆",label:"Placements"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"company-reviews",icon:"⭐",label:"Company Reviews"},{id:"profile",icon:"👤",label:"My Profile"}],
