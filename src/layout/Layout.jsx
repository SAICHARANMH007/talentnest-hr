...
// ── Nav definitions ────────────────────────────────────────────────────────────
const NAVS = {
  candidate:  [{id:"dashboard",icon:"🏠",label:"Dashboard"},{id:"smart-match",icon:"✨",label:"Find Jobs"},{id:"applications",icon:"📋",label:"My Applications"},{id:"offer-comparison",icon:"⚖️",label:"Offer Comparison"},{id:"job-alerts",icon:"🔔",label:"Job Alerts"},{id:"refer-earn",icon:"🪙",label:"Refer & Grow"},{id:"onboarding",icon:"🎯",label:"Pre-boarding"},{id:"background-verification",icon:"🛡️",label:"BGV Documents"},{id:"profile",icon:"👤",label:"My Profile"}],
