...
const NAVS = {
  ...
  college:    [{id:"analytics",icon:"📈",label:"Overview"},{id:"candidates",icon:"🎓",label:"Students"},{id:"add-candidates",icon:"📥",label:"Add Candidates"},{id:"applicants",icon:"📇",label:"Placement Records"},{id:"reviews",icon:"⭐",label:"Reviews"},{id:"feed",icon:"💬",label:"Career Community"},{id:"people",icon:"🤝",label:"My Network"},{id:"communities",icon:"🏘️",label:"Communities"},{id:"org-settings",icon:"⚙️",label:"Org Settings"},{id:"profile",icon:"👤",label:"My Profile"}],
