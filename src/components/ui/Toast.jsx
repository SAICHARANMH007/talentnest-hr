...
export default function Toast({ msg, onClose }) {
  ...
  return (
    <div className="tn-toast-wrap" style={{ position:"fixed", top:20, right:20, zIndex: Z.TOAST, background:bg, color:"#fff", padding:"13px 20px", borderRadius:12, fontSize:13, fontWeight:600, boxShadow:"0 8px 32px rgba(0,0,0,0.25)", maxWidth:360, display:'flex', alignItems:'center', gap:10 }}>
