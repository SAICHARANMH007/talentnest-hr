  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 0, color: t.text }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 24 }}>
          <label style={{ display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', alignItems: 'center', gap: 10, padding: '12px 14px', borderRadius: 10, border: `1.5px solid ${isFresher ? t.highlightBorder : t.border}`, background: isFresher ? t.highlightBg : t.surfaceBg, cursor: 'pointer' }}>
            ...
            <span style={{ flex: 1, minWidth: 0, fontSize: 14, fontWeight: 700, color: t.text }}>I'm a fresher (no work experience yet)</span>
          </label>
          {!isFresher && (
            <>
