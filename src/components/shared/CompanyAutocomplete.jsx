...
/**
 * Free-text "Company / Employer Name" input with autocomplete sourced from
 * /api/dashboard/company-directory. Suggestions come from companies other
 * candidates have already entered as their Current Company. Typing a
 * brand-new name is accepted as-is and becomes part of the directory once saved.
 */
export default function CompanyAutocomplete({ value, onChange, inputStyle, labelStyle, label = 'COMPANY / EMPLOYER NAME', placeholder = 'e.g. Acme Corp', dropdownStyle, itemStyle, itemHoverBg }) {
