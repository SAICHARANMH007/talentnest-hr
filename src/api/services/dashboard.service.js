...
export const dashboardService = {
  ...
  async getCollegeGroupCandidates(name)  { return req('GET', `/dashboard/college-groups/${encodeURIComponent(name)}/candidates`); },
  ...
  async getCompanyGroupCandidates(name)  { return req('GET', `/dashboard/company-groups/${encodeURIComponent(name)}/candidates`); },
