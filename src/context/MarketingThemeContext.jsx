...
export const THEMES = {
  ...
  mixed: {
    ...
    gradStart:   '#032D60',
    gradEnd:     '#0176D3',
    // Distinct blue-tinted backgrounds — clearly different from pure-white light theme
    sectionBg:   '#E8F4FF',
    surfaceBg:   '#D6ECFF',
    cardBg:      '#FFFFFF',
    cardBorder:  'rgba(1,118,211,0.22)',
    // Dark text on light-blue bg (still readable)
    textPrimary: '#0A1628',
    ...
    accentRgb:   '6,182,212',
    darkRgb:     '3,45,96',
    // Deep navy headings — distinct from light theme's near-black
    textHeading: '#0C2D6B',
  },
};
