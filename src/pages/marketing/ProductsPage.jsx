...
const PRODUCTS = [
  {
    ...
    bullets: [
      'Visual pipeline board — Applied through Hired in one view',
      'AI match scores on every candidate before you call',
      'Real-time chat + voice calls + HD video interviews',
      'Auto WhatsApp + email on every candidate stage move',
      'Digital offer letters with e-signature + signed PDF',
      'Assessments, outreach tracker, talent pool, bulk WhatsApp, Excel export',
    ],
  },
  {
    ...
    bullets: [
      'Live analytics: fill rate, source ROI, recruiter performance',
      'Job approval workflows + role-based recruiter management',
      'Embeddable org career page + job distribution to external boards',
      'Pre-boarding checklists auto-created when someone is hired',
      'Background document verification with notes to candidate',
      'Automation rules, custom fields, audit logs, 2FA, billing',
    ],
  },
  {
    ...
    bullets: [
      'Browse jobs + AI match score before applying',
      'Job alerts by role, skills, and location',
      'Live stage tracking + WhatsApp + email on every update',
      'Real-time chat with recruiters + receive voice calls',
      'Join video interviews from phone browser — no downloads',
      'Sign offer letter + upload pre-boarding docs from your phone',
    ],
  },
];
