...
const PRODUCTS = [
  {
    ...
    tagline:  'Your recruitment pipeline, from first application to signed offer.',
    what:     'HireBoard is where recruiters manage candidates, schedule interviews, track every stage, and extend offers — without leaving the platform.',
    bullets: [
      'Visual pipeline board: Applied → Hired',
      'AI match scores on every candidate',
      'Built-in video interview rooms',
      'Auto WhatsApp + email on every stage move',
      'Digital offer letter generation and e-signature',
      'Pipeline export to Excel',
    ],
  },
  {
    ...
    tagline:  'Organisation-wide HR control — analytics, team, offers, pre-boarding.',
    what:     'PeopleDesk gives HR managers visibility across every recruiter, every role, and every new hire — from job posting to Day 1 document verification.',
    bullets: [
      'Real-time analytics: fill rate, source ROI, time-in-stage',
      'Manage recruiters with role-based access',
      'Post jobs and manage your org career page',
      'Track and verify background documents',
      'Pre-boarding checklist management',
      'Org branding: logo, career page, offer letters',
    ],
  },
  {
    ...
    tagline:  'Apply for jobs. Know where you stand. Sign your offer from your phone.',
    what:     'JobTrack is the candidate side of TalentNest HR — job search, live application tracking, interview joining, and digital offer signing in one place.',
    bullets: [
      'Browse all company jobs on one platform',
      'AI match score before you apply',
      'Live application stage tracking',
      'Video interview join link in your dashboard',
      'Digital offer letter signing',
      'Pre-boarding checklist from your phone',
    ],
  },
];
