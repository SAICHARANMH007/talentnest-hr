...
applicationSchema.index({ tenantId: 1, source: 1, deletedAt: 1 });             // source filter
applicationSchema.index({ tenantId: 1, status: 1, deletedAt: 1, createdAt: -1 }); // status filter
