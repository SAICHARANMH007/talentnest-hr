...
const notiSchema = new mongoose.Schema({
  ...
  type    : { type: String, enum: ['application','stage_change','interview','offer','system', 'mention', 'job_approved', 'job_rejected', 'job_assignment', 'assessment', 'assessment_submitted', 'assessment_reviewed', 'invite_interested', 'invite', 'task', 'candidate_request', 'info_request', 'info_request_accepted'], default: 'system' },
